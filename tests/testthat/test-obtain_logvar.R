...
logvar1 <- obtain_logvar(gen = list(m = m, n_dep = n_dep),
                         emiss_mu = emiss_mu0,
                         var_emiss = emiss_V,
                         byrow = TRUE)

logvar2 <- obtain_logvar(gen = list(m = m, n_dep = n_dep),
...
test_that("errors prior_emiss_count input", {
  ...
  expect_error(obtain_logvar(gen = list(m = m, n_dep = n_dep),
...
test_that("output dim obtain_logvar", {
