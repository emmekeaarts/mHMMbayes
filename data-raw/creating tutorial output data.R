...
out1 <- mHMM_mnl(s_data = nonverbal, gen = list(m = m, n_dep = n_dep,
                                                q_emiss = q_emiss), start_val = list(start_TM, start_EM),
...
set.seed(9843)
out1b <- mHMM_mnl(s_data = nonverbal, gen = list(m = m, n_dep = n_dep,
                                                q_emiss = q_emiss), start_val = list(start_TM, start_EM_b),
                 mcmc = list(J = 1000, burn_in = 200))
...
# Run a model without covariate(s):
set.seed(24141)
out2 <- mHMM_mnl(s_data = nonverbal, gen = list(m = m, n_dep = n_dep,
                                                q_emiss = q_emiss), start_val = list(start_TM, start_EM),
                 mcmc = list(J = 1000, burn_in = 200))
...
# Run a model without covariate(s):
set.seed(65342)
out3 <- mHMM_mnl(s_data = nonverbal, gen = list(m = m, n_dep = n_dep,
                                                q_emiss = q_emiss), start_val = list(start_TM, start_EM),
                 mcmc = list(J = 1000, burn_in = 200))
