...
*Note: this branch is dedicated to development of __time varying covariates__.When the development is complete (e.g., documentation is complete, functions thoroughly tested), the developments will be incorporated in the master branch, and eventually in the stable R CRAN version of the mHMM package.*
...
You can install mHMMbayes that incorporates time varying covariates from github with:
...
Note that this extension is still under development, and documentation is still incomplete. 
