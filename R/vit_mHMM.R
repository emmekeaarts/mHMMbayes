...
#' from an object of either class \code{HMM} or \code{mHMM} (generated by the
#' function \code{HMM()} for a sequence of one subject or animal,
#' or\code{mHMM()} for sequences obtained from multiple subjects or animals,
...
#' output object \code{return_path} of the functions \code{HMM()} and
#' \code{mHMM()}.
#'
#' @param object An object of class \code{HMM} or \code{mHMM}, generated by the
#'   function \code{\link{HMM}} or \code{\link{mHMM}}, respectively.
#' @inheritParams mHMM
