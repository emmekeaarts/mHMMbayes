...
#'
#' @param object An object of class \code{mHMM_f}, generated by the function
#'   \code{\link{mHMM_f}}.
...
#'   creating the \code{mHMM_f} object will be used.
#'
...
#'   matrix.
#'
#' @seealso \code{\link{mHMM_f}} for fitting the multilevel hidden Markov model,
