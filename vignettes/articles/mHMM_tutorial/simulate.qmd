...
<details>
<summary>See the list of subject-specific gamma and emission distributions from the output `data3`.</summary>
...
```
<details>
<summary>See the details of the output `data4`.</summary>
