...
plot(emiss_pop,q_emiss =q_emiss,m=m,n_dep =n_dep, group_labs = group_labs)

plot(emiss_subj,q_emiss =q_emiss,m=m,n_dep =n_dep,group_labs = group_labs,subj_nr = 2,mode=2)
